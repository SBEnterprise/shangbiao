...
<body>
	...
	<div id="content">
		<div class="container">
			<div class="row">
				<div class="findbackpwdwrap_email findbackpwdwrap">
					<form id="findbackpwdform_email findbackpwdform">
						<h3>忘记密码</h3>
						<p>请输入您的注册邮箱，我们将会向您的邮箱发送一个重设密码的链接。</p>
						...
						<div class="othermeans" class="inputcontainers">
							<p>有没其他方式？试试<a href="javascript:;">手机验证码</a>找回吧</p>
						</div>
					</form>
				</div>
			</div>
