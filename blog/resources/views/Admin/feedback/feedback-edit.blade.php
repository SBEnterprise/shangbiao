...
<link rel="stylesheet" type="text/css" href="{{asset('admin/bootstrap-3.3.7/js/bootstrap.min.css')}}" id="skin"/>
			...
			<div class="tabCon">
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-6">
						<input type="text" id="website-title" name="reply" class="input-text" value="{{$data->reply}}">
					</div>
...
$('button.mybtn').click(function () {
    ...
    $.post(
        '{{url("/replyaction")}}',
        {id: id, reply: reply, _token: '{{csrf_token()}}' },
        function (data) {
            if (data.status==0) {
