        ...
        <div id="tab-system" class="HuiTab">
        	...
        	<div class="row cl">
        		...
        		<div class="formControls col-xs-8 col-sm-6">
        			<input type="text" name="obtain" id="website-description" class="input-text" placeholder="积分获取" >
        		</div>
        	</div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">积分项目:</label>
                <div class="formControls col-xs-8 col-sm-6">
                    <input type="text" name="object" id="website-uploadfile" class="input-text" placeholder="积分项目" >
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">积分说明:</label>
                <div class="formControls col-xs-8 col-sm-6">
                    <input type="text" name="integralexplain" id="website-uploadfile" class="input-text" placeholder="积分说明" >
                </div>
            </div>
        	<div class="row cl">
        		<label class="form-label col-xs-4 col-sm-2"> 积分兑换:</label>
        		<div class="formControls col-xs-8 col-sm-6">
        			<input type="text" name="integralconvert" id="website-static" class="input-text" placeholder="积分兑换" >
                </div>
        	</div>
        	<div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">积分特权:</label>
                <div class="formControls col-xs-8 col-sm-6">
                    <input type="text" name="privilege" id="website-copyright" placeholder="积分特权" class="input-text">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">积分兑现金:</label>
                <div class="formControls col-xs-8 col-sm-6">
                    <input type="text" name="cash" id="website-copyright" placeholder="积分兑现金" class="input-text">
                </div>
            </div>
            ...
            <div class="row cl">
                <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                    <button class="btn btn-primary radius pbtn"><i class="Hui-iconfont">&#xe632;</i> 添加</button>
...
$('button.pbtn').click(function () {
    ...
    $.ajax({
            type: 'post',
            dataType:'json',
            url: '{{url("admin/integralaction")}}',
            data: 'obtain='+obtain+'&object='+object+'&integralexplain='+integralexplain+'&integralconvert='+integralconvert+'&privilege='+privilege+'&cash='+cash+'&_token={{csrf_token()}}',
