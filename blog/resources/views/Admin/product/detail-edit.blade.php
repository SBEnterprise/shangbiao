			...
			<div class="tabCon">
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-6">
                        <input type="text" name="g_id" class="input-text" value="{{$data->gid}}" disabled>
						<input type="hidden" name="gid" class="input-text" value="{{$data->gid}}">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">
						...
						款式：</label>
					<div class="formControls col-xs-8 col-sm-6">
						<input type="text" name="style" class="input-text" value="{{$data->style}}">
					</div>
					<div id="aerror" class="formControls col-xs-4 col-sm-2" style="color: red;"></div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">
						<span class="c-red">*</span>
						系列：</label>
					<div class="formControls col-xs-8 col-sm-6">
						<input type="text" name="series" class="input-text" value="{{$data->series}}">
					</div>
					<div id="berror" class="formControls col-xs-4 col-sm-2" style="color: red;"></div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">
						<span class="c-red">*</span>
						表带:</label>
					<div class="formControls col-xs-8 col-sm-6">
						<input type="text" name="watch_strap" class="input-text" value="{{$data->watch_strap}}">
					</div>
					<div id="cerror" class="formControls col-xs-4 col-sm-2" style="color: red;"></div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">
						<span class="c-red">*</span>
						表带颜色:</label>
					<div class="formControls col-xs-8 col-sm-6">
						<input type="text" name="braceletColor" class="input-text" value="{{$data->braceletColor}}">
					</div>
					<div id="derror" class="formControls col-xs-4 col-sm-2" style="color: red;"></div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">
						<span class="c-red">*</span>
						表扣</label>
					<div class="formControls col-xs-8 col-sm-6">
						<input type="text" name="buckle" class="input-text" value="{{$data->buckle}}">
					</div>
					<div id="eerror" class="formControls col-xs-4 col-sm-2" style="color: red;"></div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">表壳:</label>
					<div class="formControls col-xs-8 col-sm-6">
						<input type="text" name="watch_case" class="input-text" value="{{$data->watch_case}}">
					</div>
					<div id="ferror" class="formControls col-xs-4 col-sm-2" style="color: red;"></div>
				</div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2">机芯型号:</label>
                    <div class="formControls col-xs-8 col-sm-6">
                        <input type="text" name="movement_name" class="input-text" value="{{$data->movement_name}}">
                    </div>
                    <div id="reerror" class="formControls col-xs-4 col-sm-2" style="color: red;"></div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2">表盘尺寸:</label>
                    <div class="formControls col-xs-8 col-sm-6">
                        <input type="text" name="dial_size" class="input-text" value="{{$data->dial_size}}">单位：mm
                    </div>
                    <div id="gerror" class="formControls col-xs-4 col-sm-2" style="color: red;"></div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2">表盘厚度:</label>
                    <div class="formControls col-xs-8 col-sm-6">
                        <input type="text" name="dial_thickness" class="input-text" value="{{$data->dial_thickness}}">单位：mm
                    </div>
                    <div id="herror" class="formControls col-xs-4 col-sm-2" style="color: red;"></div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2">手表重量:</label>
                    <div class="formControls col-xs-8 col-sm-6">
                        <input type="text" name="weight" class="input-text" value="{{$data->weight}}">单位：g
                    </div>
                    <div id="ierror" class="formControls col-xs-4 col-sm-2" style="color: red;"></div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2">年份:</label>
                    <div class="formControls col-xs-8 col-sm-6">
                        <input type="text" name="year" class="input-text" value="{{$data->year}}">
                    </div>
                    <div id="jerror" class="formControls col-xs-4 col-sm-2" style="color: red;"></div>
                </div>
			</div>
